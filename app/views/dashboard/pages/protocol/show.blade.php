				...
				<div class="row">
					<a href="{{route('examenes.create', $protocol->id)}}" class="widget" title="Presentar Examen">
						...
						<div class="widget-content text-center">
							<div class="pie-chart easyPieChart" data-percent="{{$protocol->best_exam}}" data-line-width="3" data-bar-color="#cccccc" data-track-color="#f9f9f9" style="width: 80px; height: 80px; line-height: 80px;">
								<span><strong>{{$protocol->best_exam}}%</strong></span>
								<canvas width="80" height="80"></canvas>
							</div>
						</div>
						<div class="widget-content themed-background-muted">
							<div class="progress progress-striped progress-mini active remove-margin">
								<div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="{{$protocol->best_exam}}" aria-valuemin="0" aria-valuemax="100" style="width: {{$protocol->best_exam}}%"></div>
							</div>
						</div>
					</a>
				</div>
