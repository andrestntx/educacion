						...
						<ul class="list-unstyled">
		                    @foreach($links as $link)
	                            <li title="{{$link->description}}">
	                            	<div class="row">
		                            	<div class="col-sm-7">
		                            		<h4><a href="{{URL::to($link->url)}}" target="_blank">{{$link->name}}</a></h4>
		                            	</div>
		                            	<div class="col-sm-5">
				                            <a href="{{route('protocolos.enlaces.edit', array($protocol->id, $link->id))}}" data-toggle="tooltip" title="Editar Anexo" class="btn btn-sm btn-effect-ripple btn-warning">
				                                <i class="fa fa-pencil"></i>
				                            </a>
