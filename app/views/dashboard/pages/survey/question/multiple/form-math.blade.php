      ...
      @if(!$question->exists)
        @for($i=1; $i <= $number_answers; $i++ )
          <div class="form-group">
            ...
            <div class="col-md-2">
              {{ Form::text('answers['.$i.'][value]', null, array('required' => 'required', 
                  'placeholder' => 'Valor '.$i, 'class' => 'form-control')) }}
            </div>
          </div>
        @endfor
      @else
        @foreach($question->answers as $answer)
            <div class="form-group">
              ...
              <div class="col-md-2">
                {{ Form::text('answers['.$answer->id.'][value]', $answer->value, array('required' => 'required', 
