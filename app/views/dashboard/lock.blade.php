...
<html class="lockscreen">
    <head>
        <meta charset="UTF-8">
        <title>@yield('title', 'Educación Continuada | Dashboard suspendido')</title>
    ...
    <body>
        ...
        <div class="center">            
                ...
                <div class="lockscreen-credentials">   
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <a href="{{url('dashboard')}}" class="btn btn-flat"><i class="fa fa-arrow-right text-muted"></i></a>
                        </div>
                    </div>
            ...
            <div class="lockscreen-link">
                <a href="login.html">O iniciar sesión con otro usuario</a>
            </div>            
        </div><!-- /.center -->
