...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Educación Continuada - Nuevo Formulario</title>
        <meta name="viewport" content="width=device-width" />
        <style type="text/css">
            @media only screen and (max-width: 550px), screen and (max-device-width: 550px) {
                body[yahoo] .buttonwrapper { background-color: transparent !important; }
                body[yahoo] .button { padding: 0 !important; }
                body[yahoo] .button a { background-color: #0072c6; padding: 15px 25px !important; }
            }
    ...
    <body bgcolor="#454e59" style="margin: 0; padding: 0;" yahoo="fix">
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            <tr>
                <td align="center" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="{{URL::to($company_logo)}}" alt="Company Logo" width="80" height="80" style="display:block;" />
                </td>
            </tr>
            <tr>
                <td align="center" bgcolor="#0072c6" style="padding: 25px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 26px;">
                    <b>Haz realizado un nuevo Registro de Formulario</b>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 0 20px 40px 20px; color: #777777; font-family: Arial, sans-serif; font-size: 18px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                    Todos los registros quedan guardados en la Aplicación
                </td>
            <tr>
                <td align="center" bgcolor="#f9f9f9" style="padding: 30px 20px 30px 20px; font-family: Arial, sans-serif;">
                    <table bgcolor="#0072c6" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                        <tr>
                            <td align="center" height="55" style=" padding: 0 35px 0 35px; font-family: Arial, sans-serif; font-size: 22px;" class="button">
                                <a href="{{URL::to($pdf_path)}}" style="color: #ffffff; text-align: center; text-decoration: none;">Descargar ahora!</a>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" width="100%" style="color: #999999; font-family: Arial, sans-serif; font-size: 12px;">
                                2015 &copy; <a href="http:www.histoweb.com" style="color: #0072c6;">Educación Continuada</a>
                            </td>
                        </tr>
                    </table>
                </td>
